...
Архив с тестами https://stepik.org/media/attachments/lesson/647292/tests_2676893.zip
GitHub https://github.com/python-generation/Professional/tree/main/Module_9/Module_9.4/Module_9.4.12
...
def print(*args, sep=' ', end='\n'):
    ...
    for a in args:
        if isinstance(a, str):
            ...
            res.append(str(a))
    sys.stdout.write(sep.upper().join(res))
