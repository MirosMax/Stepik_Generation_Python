...
Архив с тестами https://stepik.org/media/attachments/lesson/640035/tests_2655749.zip
GitHub https://github.com/python-generation/Professional/tree/main/Module_9/Module_9.1/Module_9.1.10
Sample Input 1:
...
def is_greater(lists, num):
    return any(map(lambda li: sum(li) > num, lists))
