...
Архив с тестами https://stepik.org/media/attachments/lesson/640035/tests_2655747.zip
GitHub https://github.com/python-generation/Professional/tree/main/Module_9/Module_9.1/Module_9.1.9
Sample Input 1:
...
def non_negative_even(num):
    return all(map(lambda a: a % 2 == 0 and a >= 0, num))
