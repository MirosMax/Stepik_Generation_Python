...
alive = (n for n in persons if n.death == 0)
mens = (n for n in alive if n.sex == 'male')
sweden = (n for n in mens if n.nationality == 'Swedish')
young = max(sweden, key=lambda n: n.birth)
print(young.name)